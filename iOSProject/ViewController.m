...
- (void)viewDidLoad {
    ...
    self.dataArray = [NSMutableArray arrayWithObjects:@"DataBaseViewController",@"StackViewDemo",@"TagsViewController",@"DateViewController",@"MenuViewController",@"RequestDemoController", nil];
